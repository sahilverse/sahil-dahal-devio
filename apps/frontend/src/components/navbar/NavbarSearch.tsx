...
export default function NavbarSearch() {
    ...
    return (
        <div
            className={`flex items-center gap-2 border rounded-full px-4 py-2 w-full min-w-[500px] max-w-[800px] mx-4 transition-colors
            ${isFocused ? "border-brand-primary ring-1 ring-brand-primary" : "border-gray-300 dark:border-gray-700"}`}
        >
            <Image src="/devio-logo.png" width={28} height={28} alt="Search" loading="eager" />
