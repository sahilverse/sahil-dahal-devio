...
export default function Sidebar() {
    ...
    const resources = [
        { name: "Solve Problems", href: "/problems", icon: Code },
    ...
    return (
        <aside
            className={cn(
                "flex flex-col h-[calc(100vh-73px)] sticky top-[73px] bg-white dark:bg-transparent border-r border-gray-200 dark:border-gray-800 transition-all duration-300",
                isSidebarOpen ? "w-64 pr-2" : "w-0 p-2"
            )}
        >
            {/* Toggle Button  */}
            <button
                onClick={() => dispatch(toggleSidebar())}
                className="absolute -right-4 top-6 z-10 w-8 h-8 flex items-center justify-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-700 dark:text-gray-200 shadow-sm cursor-pointer"
            >
