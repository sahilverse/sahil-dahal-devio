        ...
        <div className="flex flex-col h-screen w-full bg-background overflow-hidden">
            ...
            <header className="h-14 shrink-0 border-b border-border/50 bg-background/95 backdrop-blur z-50 flex items-center justify-between px-4 lg:px-6">
                <div className="flex items-center gap-4">
                    <Link href="/learn" className="text-muted-foreground hover:text-foreground transition-colors flex items-center justify-center p-2 rounded-md hover:bg-muted/50">
                ...
                <div className="flex items-center gap-4 text-sm font-medium">
                    {/* Placeholder for actual progress later */}
